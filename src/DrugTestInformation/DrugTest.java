...
public class DrugTest extends Application {
    ...
    public void start(Stage stage) throws Exception {
        root = FXMLLoader.load(getClass().getResource("DrugTestFXML.fxml"));
        Scene scene = new Scene(root);
        scene.getStylesheets().add(("/css/drugTest_main.css"));
        stage.setScene(scene);
        stage.initStyle(StageStyle.TRANSPARENT);
        stage.show();
        stage.setTitle("Crime Laboratory DIGS");
        this.stage = stage;
        locX = stage.getX();
        locY = stage.getY();
